...
import com.example.backend.utils.CsvFileGenerator;
...
public class CSVController {
    ...
    public ResponseEntity<List<Job_Type>> getAllTutorials() {
        try {
            List<Job_Type> jobs = fileService.getAllJobTypes();
    ...
    public void exportIntoCSV(HttpServletResponse response) throws IOException {
        ...
        csvGenerator.writeCompaniesToCsv(companyService.findAll(), response.getWriter());
    }
